...
import AppBlobDisplay, { AppBlobDisplayProps } from "./AppBlobDisplay";

export default {
  title: "AppBlobDisplay",
  component: AppBlobDisplay,
} as Meta;

const Template: Story<AppBlobDisplayProps> = (args) => (
  <AppBlobDisplay {...args} />
);
...
Base.args = {
  ...
  byteSize: 3123,
  rawHref: {
    pathname: "/topheman/nextjs-github-browser/blob/master",
    query: {
